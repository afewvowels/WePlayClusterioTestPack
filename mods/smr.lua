...
local function modifySMRGenerator(name)
    ...
    flow_limit = flow_limit * 100000
    data.raw["accumulator"][name].energy_source.output_flow_limit = flow_limit .. "MW"
    data.raw["accumulator"][name].energy_source.input_flow_limit = (flow_limit * 2) .. "MW"
end
...
data.raw["item-with-tags"]["smr-generator-1"].stack_size = 50
data.raw["item-with-tags"]["smr-generator-2"].stack_size = 50
data.raw["item-with-tags"]["smr-generator-3"].stack_size = 50